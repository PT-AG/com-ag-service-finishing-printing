...
namespace Com.Danliris.Service.Packing.Inventory.Test.DataUtils.GarmentShipping.GarmentShippingInvoice
{
	public class GarmentShippingInvoiceDataUtil : BaseDataUtil<GarmentShippingInvoiceRepository, GarmentShippingInvoiceModel>
	{
		...
		public override GarmentShippingInvoiceModel GetEmptyModel()
		{
            ...
            var model = new GarmentShippingInvoiceModel(0, null, DateTimeOffset.MinValue, null, null, 0, null, null, null, null, null, 0, null, null, DateTimeOffset.MinValue, null, 0, null, 0, null, 0, null, 0, "", DateTimeOffset.MinValue, "", DateTimeOffset.MinValue, "", "", items, 0, 0, "", "dsdsds", "memo", false, null, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, null, DateTimeOffset.MinValue, adjustments, 0,null,null,units, "", "", null, null);
        ...
        public GarmentShippingInvoiceModel CopyModel(GarmentShippingInvoiceModel om)
        {
            ...
            var model = new GarmentShippingInvoiceModel(om.PackingListId, om.InvoiceNo,om.InvoiceDate,om.From,om.To,om.BuyerAgentId,om.BuyerAgentCode,om.BuyerAgentName,om.Consignee,
                ...
                om.CO,om.CODate,om.COTP,om.COTPDate,adjs, om.TotalAmount, om.ConsigneeAddress, om.DeliverTo, units, om.UserAuthorizedName, om.PackingListType, null, null) { Id = om.Id };
